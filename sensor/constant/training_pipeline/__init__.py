...
# Defining common constant variable for training_pipeline
TARGET_COLUMN = "class"
...
PREROCESSING_OBJECT_FILE_NAME = "preprocessing.pkl"
...
# Model Evaluation related constant start with MODEL_EVALUATION name.
